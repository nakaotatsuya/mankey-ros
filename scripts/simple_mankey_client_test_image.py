...
def main():
    ...
    cv2.circle(cv_rgb, (289,239) , 2, color=(255,0,0), thickness=2)
    cv2.circle(cv_rgb, (318,244) , 2, color=(255,0,0), thickness=2)
    cv2.circle(cv_rgb, (288,218) , 2, color=(255,0,0), thickness=2)
